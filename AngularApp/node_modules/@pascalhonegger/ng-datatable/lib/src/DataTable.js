...
var DataTable = (function () {
    ...
    DataTable.prototype.setSort = function (sortBy, sortOrder) {
        if (this.sortBy !== sortBy || this.sortOrder !== sortOrder) {
            this.sortBy = sortBy;
            this.sortOrder = lodash_1.includes(["asc", "desc"], sortOrder) ? sortOrder : "asc";
    ...
    DataTable.prototype.ngOnChanges = function (changes) {
        ...
        if (changes["sortBy"] || changes["sortOrder"]) {
            if (!lodash_1.includes(["asc", "desc"], this.sortOrder)) {
    ...
    DataTable.prototype.fillData = function () {
        ...
        if (typeof sortBy === 'string' || sortBy instanceof String) {
            data = lodash_1.orderBy(data, this.caseInsensitiveIteratee(sortBy), [this.sortOrder]);
        }
        else {
            data = lodash_1.orderBy(data, sortBy, [this.sortOrder]);
        }
        data = lodash_1.slice(data, offset, offset + this.rowsOnPage);
        this.data = data;
    };
